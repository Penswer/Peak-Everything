...
public class Plugin : BaseUnityPlugin
{
    ...
    internal static Texture2D backgroundTex = new Texture2D(1, 1);
    ...
    internal static void MyUI()
    {
        ...
        if (showMenu)
        {
            ...
            background.normal.background = backgroundTex;
            GUILayout.BeginArea(new Rect(0, 0, 400, 1000), background);
            GUILayout.BeginVertical();
            GUILayout.Label("Everything Menu");
            GUILayout.Button("Woah");
